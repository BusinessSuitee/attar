...
ar.gallery_page = {
  hero: {
    ...
    subtitle:
      'توثيق بصري لرحلة أولاد العطار في الزراعة والتصدير.. جولة داخل مزارعنا ومحطات الفرز الحديثة التي تضمن أعلى درجات الجودة.',
  },
  filters: {
    all: 'الكل',
...
en.gallery_page = {
  hero: {
    ...
    subtitle:
      "A visual documentation of Alatar Sons' journey in agriculture and export. A tour inside our farms and modern sorting stations ensuring the highest quality.",
  },
  filters: {
    all: 'All',
    farms: 'Farms & Lands',
  ...
  items: {
    crops_1: {
      title: 'Egyptian Oranges for Fresh Consumption',
      description: 'Premium winter crop for export.',
    },
...
ru.gallery_page = {
  hero: {
    ...
    subtitle:
      'Визуальное документирование пути Сыновей Алатара в сельском хозяйстве и экспорте. Экскурсия по нашим фермам и современным сортировочным станциям, обеспечивающим высочайшее качество.',
  },
  filters: {
    all: 'Все',
    farms: 'Фермы и земли',
  ...
  items: {
    crops_1: {
      title: 'Египетские апельсины для свежего потребления',
      description: 'Премиальный зимний урожай для экспорта.',
    },
