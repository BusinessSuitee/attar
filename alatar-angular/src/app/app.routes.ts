...
export const routes: Routes = [
	{
		path: '',
		loadComponent: () => import('./pages/home/home.page').then((module) => module.HomePageComponent)
	},
	{
		path: 'about',
		loadComponent: () => import('./pages/about/about.page').then((module) => module.AboutPageComponent)
	},
	{
		path: 'partners',
		loadComponent: () =>
	...
	},
	{
		...
		loadComponent: () =>
			import('./pages/admin-login/admin-login.page').then((module) => module.AdminLoginPageComponent)
	},
	{
		path: 'admin',
